...
@onready var life2 = $"Horizontal lives/LIFE 2"
@onready var life3 = $"Horizontal lives/LIFE 3"
...
func update_lives():
	# Reset the lives to the full state
	life1.texture = preload("res://Main Assets/Pacman/Pacman_03.png")
	life2.texture = preload("res://Main Assets/Pacman/Pacman_03.png")
	life3.texture = preload("res://Main Assets/Pacman/Pacman_03.png")
